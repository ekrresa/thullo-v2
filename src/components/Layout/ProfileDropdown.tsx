...
export function ProfileDropdown() {
  ...
  return (
    <Popover className="relative">
      ...
      >
        <Popover.Panel className="absolute top-10 left-1/2 z-10 flex min-w-max -translate-x-1/2 flex-col items-center gap-1 overflow-hidden rounded-lg bg-white p-2 shadow-md ring-1 ring-black/5 md:w-32">
          <Popover.Button
            as={Link}
            href={ROUTES.profile}
